...
export const BankDetailsStep: React.FC<BankDetailsStepProps> = ({
  ...
  // Only show this step for external bank transfers
  if (method !== 'external-bank') {
    return null;
  }
    ...
    >
      <div>
        ...
        <p className="text-charcoal-700">
          Provide your bank account information to complete the transfer.
        </p>
      </div>
      ...
      >
        <p className="text-sm text-green-900">
          🔒 <strong>Your information is secure:</strong> We use bank-level encryption to protect your bank details. We never store your full account number.
        </p>
      </motion.div>
